          ...
          <div className="col-12">
            ...
            <article className="release-notes-card-box">
              <p>
                ...
                the <strong>Big Mad Winnings</strong> contest… a chance to win
                BMW motorbike, iPhone 14, and a host of other awesome prizes.
              </p>
              <p>
                Did you ever imagine your NFT buying could be so rewarding?{" "}
              </p>
              <p>
              ...
              <p>
                All those who purchase at least 2 NFTs in the above mentioned
                ...
                <div className="row justify-content-start">
                  ...
                  <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div className="contest-card">
                      ...
                      <div className="winner-content">
                        <p>
                          With the latest, don't Be Just Stylish! Be iStylish
                        </p>
                        <div className="winner-count d-flex justify-content-between align-items-center">
                          <p>Winners:</p>
                          <p>1</p>
                  ...
                  <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div className="contest-card">
                      ...
                      <div className="winner-content">
                        <p>
                          When your Gaming Rage Isn't Okay With Ordinary Specs!
                        </p>
                        <div className="winner-count d-flex justify-content-between align-items-center">
                          <p>Winners:</p>
                          <p>2</p>
                  ...
                  <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div className="contest-card">
                      ...
                      <div className="winner-content">
                        <p>
                          A Universe Of Possibilities With This 'Galaxy' of a
                          Device!
                        </p>
                        <div className="winner-count d-flex justify-content-between align-items-center">
                          <p>Winners:</p>
                  ...
                  <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div className="contest-card">
                      ...
                      <div className="winner-content">
                        <p>
                          You've Heard Enough Of How This Nothing Is Something,
                          eh?
                        </p>
                        <div className="winner-count d-flex justify-content-between align-items-center">
                          <p>Winners:</p>
                  ...
                  {/* <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div className="contest-card">
                      ...
                      <div className="winner-content">
                        <p>
                          The GuardianLink Classic! Ssshhh! Crypto Rewards
                          Inside!
                        </p>
                        <div className="winner-count d-flex justify-content-between align-items-center">
                          <p>Winners:</p>
              ...
              <ul className="card-key-points">
                <li>
                  ...
                  NFT to be eligible to participate in this contest.
                </li>
                <li>
                  The contest is subject to the laws and regulations of the
                  Republic of India.
                </li>
                <li>
                  The organizer reserves the sole right and absolute discretion
                  to extend or terminate the contest without any prior notice to
                  any party.
                </li>
                <li>
                  ...
                  non-verification or inadequate verification might result in
                  them forfeiting their prize.
                </li>
                <li>
                  The participant agrees that they are cognizant of the rules
                  and regulations of their states/jurisdictions regarding
                  participation in such contests and the participant agrees that
                  they are solely responsible for any discrepancies that might
                  arise.
                </li>
                <li>
                  The organizer reserves the right to cancel the participation
                  of participants engaging in unfair and malicious practices
                  including but not limited to using bots and wash trading.
                </li>
                <li>
                  The participant consents to the bearing of additional costs
                  and other deductions at source related to the prize. The
                  organizer will not be responsible for the costs and the
                  organizer reserves the right to make their decision in case of
                  such discrepancies.
                </li>
              </ul>
              <span className="contest-link">
                <Link to={`/bmw-contest-terms-and-conditions`}>
