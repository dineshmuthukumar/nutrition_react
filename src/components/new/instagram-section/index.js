...
const InstagramSection = () => {
  ...
  return (
    <>
       <section className="instagram-section pt-2 pt-md-7 pt-10 pb-8 appear-animate"
                            data-animation-options="{'delay': '.2s', 'duration': '.5s' }">
                        <div className="container">
                            <h2 className="title-echo mb-1"><span>Enjoy the Supplementing Routes that we Made for you!</span></h2>
                            <p>No more boring methods – Liven makes the convenient routes <br />for all people making them free of hesitating or hard methods of supplementation.</p>
                            {/* <div
                            ...
                            >
                                <figure className="instagram">
                                    <a href="product.html">
                                        ...
                                        <br />
                                        <span className="categories_title_name"><h5>Plant Protein</h5></span>
                                    </a>
                                </figure>
                                <figure className="instagram">
                                    <a href="product.html">
                                        ...
                                        <br />
                                        <span className="categories_title_name"><h5>Slow</h5></span>
                                    </a>
                                </figure>
                                <figure className="instagram">
                                    <a href="product.html">
                                        ...
                                        <br />
                                        <span className="categories_title_name"><h5>Melts</h5></span>
                                    </a>
                                </figure>
                                <figure className="instagram">
                                    <a href="product.html">
                                        ...
                                        <br />
                                        <span className="categories_title_name"><h5>Kids</h5></span>
                                    </a>
                                </figure>
                                <figure className="instagram">
                                    <a href="product.html">
                                        ...
                                        <br />
                                        <span className="categories_title_name"><h5>Effervescent</h5></span>
                                    </a>
                                </figure>
                            </OwlCarousel>
                        </div>
