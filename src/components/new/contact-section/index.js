                    ...
                    <div className="col-lg-3 col-md-4 col-sm-6 ls-m mb-4">
                        <div className="grey-section d-flex align-items-center h-100">
                            <div>
                                ...
                                <p>
                                    <Link to = '' ClassName="btn btn-link">1.800.458.56</Link><br/>
                                    <Link to = '' ClassName="btn btn-link">1.800.458.56</Link>
                                </p>
                                <h4 className="mb-2 text-capitalize">Support</h4>
                                <p className="mb-4">
                                <Link to = '' ClassName="btn btn-link">support@your-domain.com</Link><br/>
                                <Link to = '' ClassName="btn btn-link">help@your-domain.com</Link>
                                </p>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="change_pass">
                                    ...
                                    <Row>
                                        <Col md={{ span: 6, offset: 3 }}>
                                            <button type="submit" class="btn-product btn-cart wid_200">Contact Us</button>
                                        </Col>
                                    </Row>
                                </div>
                        </div>
