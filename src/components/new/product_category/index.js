        ...
        <div className="row align-items-center">
          <div className="col-md-12 mb-4">
            ...
            <p className="section-desc text-grey">
              ...
              natural flavorings, colors and hydrophilic lubricants. Each one is
              maintained with integrity and protected from moisture by proper
              manufacturing and packing procedure. The effervescent tablets are
              packed in tight, moisture-free plastic tubes with Desiccants.
            </p>
          </div>
        </div>
        <div className="row align-items-center">
          ...
          <div className="row cols-sm-2 cols-lg-4 code-content">
            ...
            <div className="image-overlay">
              <figure className="banner-radius">
                ...
                <div className="overlay overlay-transparent">
                  <p className="">
                    This fizzy formulation is effective enough to deliver proper
                    nutrients to the consumer in a safe manner. There are no
                    health-harming compounds and this formula has undergone
              ...
              <div className="banner banner-4 banner-fixed banner-radius overlay-effect2 content-middle content-center appear-animate fadeIn appear-animation-visible">
                ...
                >
                  <div className="mr-auto mb-4 mb-md-0">
                    ...
                    <p className="text-white">
                      There are no health-harming compounds and this formula has
            ...
            <div className="table-responsive table-bordered">
              <table className="table">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>
                      <i className="fas fa-certificate"></i> Good for Gut Health
                    </td>
                  </tr>
                  <tr>
                    <td>
            ...
            <div className="table-responsive table-bordered">
              <table className="table">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>
                      <i className="fas fa-certificate fa-red"></i> Not good for
                      the Gut
                    </td>
                  </tr>
                  <tr>
