...
<div className="new_drop_wrapper">
                    ...
                    <div className="row align-items-center justify-content-center">
                        ...
                        <div className="col-xxl-7 col-xl-6 col-lg-5 col-md-9 col-xs-10 order-1 order-lg-2">
                            <div className="content-img content-img--l4-1">
                                <Image src="https://amitabh.bafdemo.com/static/media/artist-image.2236b257.png" rounded /> </div>
                        </div>
                    </div>
                    <div className="row">
                        <div className="scroll-drops my-4"> <a href="#drop_1">Scroll for all Drops</a> </div>
                    </div>
                </div>
            </section>
                        ...
                        <div className="app-showcase">
                            <Navbar className="kd-feature-tabs">
                                <div className="nav nav-tabs sticky-tabs">
                                    <Link to="#drop_1" className="nav-label"> Collection 1: <span>Madhushala</span> </Link>
                                    <Link className="nav-label"> Collection 2: <span>Posters</span> </Link>
                                    <Link className="nav-label"> Collection 3:<span> Cryptopunks</span> </Link>
                                </div>
                            </Navbar>
                        </div>
                    </div>
            ...
            <section className="drop-newsletter">
                <div className="container">
                    <div className="row">
                        <h1>Are you the one going to make it big in India? 
                    <span>Own an NFT.</span></h1> </div>
                    <Form id="nft_form">
                        <Form.Group className="formGroup mb-3" controlId="formBasicEmail">
                            <Form.Control className="nft_form_email" type="email" name="Nemail" placeholder="name@example.com" />
            ...
            <div id="footer">
                <div id="fmenu1">
                    <div class="submenu">
                        <div> <a href="index.php"><h1>BeyondLife.club</h1></a>
                    ...
                    <div class="submenu">
                        <ul>
                            <li><a href="about.php">About: The world beyond end</a></li>
                            <li><a href="philosophy.php">Philosophy of BeyondLife.club</a></li>
                            <li><a href="nft.php">What is an NFT? </a></li>
                ...
                <div id="fmenu2">
                    ...
                    <div class="submenu">
                        <a target="_blank" href="https://www.guardianlink.io">
                            <Image src="https://cdn.beyondlife.club/media/logo_horizondal.png" alt="alt" />
                        </a>
                    </div>
                </div>
            </div>
